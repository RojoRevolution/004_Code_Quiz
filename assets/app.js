...
// Empty array used to push to LS
let highScore = []
...
// click event for the view scores button
viewScoreBtn.addEventListener('click', () => {
    viewScoreBtn.classList.add('hide');
    quizContentDiv.classList.add('hide');
    highScoreDiv.classList.remove('hide');
});
// Click to close the view scores section
closeIcon.addEventListener('click', () => {
    ...
    // reload when score list is closed
    location.reload();
})